...
const Login = () => {
  ...
  const handleLogin = (email, password) => {
    ...
    axios
      .post(`https://finance-api-kgh1.onrender.com/api/login`, request, {
        headers: {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity>
          <Text style={{ color: "#009387", marginTop: 30, marginLeft: 250 }}>
            Forgot password?
          </Text>
        </TouchableOpacity>
        ...
        <View style={styles.imageContainer}>
          ...
          <Image
            style={styles.imageLogo}
            source={{
              uri: "https://logowik.com/content/uploads/images/gmail-new-icon5198.jpg",
            }}
          />
        </View>
