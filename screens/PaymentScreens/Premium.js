    ...
    <ScrollView>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={{ fontSize: 25, fontWeight: "bold", color: "#80489C" }}>
            Premium with MaMa
          </Text>
        </View>
        <View style={styles.informationHeader}>
          <View style={styles.information}>
            <Ionicons name="checkmark-outline" size={25} color="#5D9C59" />
            <Text
              style={{
                fontSize: 20,
                fontWeight: "500",
        ...
        <View>
          ...
          >
            <Text
              style={{ color: "#7B8FA1", fontWeight: "700", marginBottom: 30 }}
            >
              NOT NOW
            </Text>
          </TouchableOpacity>
