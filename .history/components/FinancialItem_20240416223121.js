...
export default function FinancialItem({ type, item }) {
  ...
  async function handleDeleteItem(itemId) {
    ...
    //     const endpoint = type === "Income" ? "deleteIncome" : "deleteExpenses";
    //     try {
    //         await axios.delete(`https://finance-api-kgh1.onrender.com/api/${endpoint}/${id}/${itemId}`);
    ...
    >
      <View style={styles.expenseRow}>
        <View style={styles.expenseCategory}>
          ...
          <Text
            style={{ fontSize: 10, fontSize: 13, width: 110, marginBottom:  }}
          >
            {item.note}
          </Text>
        </View>
