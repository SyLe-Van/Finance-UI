...
import UpdateStack from "../screens/AddStack";
...
//handleUpdateItem
function handleUpdateItem(type) {
  if (type === "Income") {
    navigation.navigate("UpdateStack", { screen: "UpdateIncome" });
  } else {
    navigation.navigate("UpdateStack", { screen: "UpdateExpenses" });
  }
}
return (
  <TouchableHighlight
