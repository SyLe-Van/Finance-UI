...
const styles = StyleSheet.create({
  ...
  touch: {
    borderRadius: 10,
    overflow: "hidden", // Để loại bỏ các thành phần bên ngoài của TouchableHighlight
    width: 360, // Đảm bảo TouchableHighlight bao quanh hoàn toàn SpendingInfo
    height: 160, // Đảm bảo TouchableHighlight bao quanh hoàn toàn SpendingInfo
  },
  spendingInfoWrapper: {
    justifyContent: "center", // Cân bằng nằm giữa dọc
    alignItems: "center", // Cân bằng nằm giữa ngang
    flex: 1, // Đảm bảo SpendingInfo chiếm toàn bộ không gian trong TouchableHighlight
  },
  pressed: {
