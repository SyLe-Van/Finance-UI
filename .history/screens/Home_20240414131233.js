...
const Home = ({ route }) => {
  const { updateData, setUpdateData, userId, setIsPremium } =
  ...
  useEffect(() => {
    // console.log(id);
    axios
      .get(`https://finance-api-kgh1.onrender.com/api/getUser/${userId}`, {
        headers: {
    ...
    axios
      .get(`https://finance-api-kgh1.onrender.com/api/getExpenses/${userId}`, {
        headers: {
          "Content-Type": "application/json",
        },
      })
  ...
  useEffect(() => {
    console.log(id);
    axios
      .get(`https://finance-api-kgh1.onrender.com/api/getIncomes/${userId}`, {
        headers: {
          "Content-Type": "application/json",
        },
      })
