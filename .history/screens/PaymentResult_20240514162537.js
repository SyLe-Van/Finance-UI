...
export default function Result() {
  ...
  const formatNumberWithDot = (number) => {
    ...
    // Định dạng phần nguyên: loại bỏ các chữ số 0 sau dấu thập phân nếu có
    parts[0] = parts[0].replace(/\.?0*$/, "");

    // Kết hợp lại phần nguyên và phần thập phân nếu có, chỉ hiển thị phần thập phân nếu nó khác 00
    return parts[1] !== "00" ? `${parts[0]}.${parts[1]}` : parts[0];
  };
