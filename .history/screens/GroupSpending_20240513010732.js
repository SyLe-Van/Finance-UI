    ...
    >
      <View style={styles.spendingInfoWrapper}>
        <SpendingInfo
          ...
          // onChangeText={(cost, notes) => handleTextChange(index, cost, notes)}
          onUpdateCost={(cost) =>
            handleTextChange(index, cost, notesInputs[index])
          }
          onUpdateNote={(note) =>
            handleTextChange(index, costInputs[index], note)
          }
        />
      </View>
    </TouchableHighlight>
